...
df = pd.read_csv('classificacoes_musicaJACKSON.csv')
dados_emocoes = df.drop(columns=['Trecho_Inicial'], errors='ignore')

# Carregar o áudio
audio_path = r"C:\base\EXPERIMENTO5\Michael Jackson.mp3"
...
ax.set_title("Michael Jackson - Billie Jean = Evolução das Emoções ao Longo da Música em Barras")
...
final_video_path = 'final_videoJACKSON.mp4'
