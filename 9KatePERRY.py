...
df = pd.read_csv('classificacoes_musicaKATEPERRY.csv')
dados_emocoes = df.drop(columns=['Trecho_Inicial'], errors='ignore')

# Carregar o áudio
audio_path = r"C:\base\EXPERIMENTO3\Katy Perry - Dark Horse ft. Juicy J [0KSOMA3QBU0].mp3"
...
ax.set_title("Katy Perry - Dark Horse ft. Juicy J = Evolução das Emoções ao Longo da Música em Barras")
...
final_video_path = 'final_videoKATEPERRY.mp4'
