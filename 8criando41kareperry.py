...
segmentos_dir = r'C:\base\EXPERIMENTO3\output_segments'  # Diretório com arquivos segment_X-Y.mp3
output_dir = r'C:\base\EXPERIMENTO3\EspecsTOT'  # Diretório temporário para salvar espectrogramas
...
# Salvar em CSV
df.to_csv('classificacoes_musicaKATEPERRY.csv', index=False)
print("Tabela de classificações salva como 'classificacoes_musicaKATEPERRY.csv'")